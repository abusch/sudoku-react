...
const App = () => {
  ...
  const handleKeyDown = (event) => {
    var x = boardData.selectedColumn;
    var y = boardData.selectedRow;
    ...
    setBoardData({selectedColumn: x, selectedRow: y});
  ...
  useEffect(() => {
    ...
    return (
      <div className="content">
        <h1>SUDOKU</h1>
        <Board
          cellData={boardData.data}
          selectedRow={boardData.selectedRow}
          selectedColumn={boardData.selectedColumn} />
